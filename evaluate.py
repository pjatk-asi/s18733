...
def evaluate_fun(iteration):
    print('evaluate_fun for data set number: ' + iteration)
    data_file_name = 'data'+ iteration + '/dataset-init.csv'
    ...
    eval_df = eval_df.append({'datasetNumber':iteration, 'time_stamp':now, 'version': '1.0', 'batch': 2, 'metric': 'accuracy', 'accuracy': accuracy}, ignore_index=True)
